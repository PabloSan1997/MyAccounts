...
- **Field Injection with @Autowired:** Use `@Autowired` for injecting dependencies. This is the preferred pattern in this project.
- **Immutability:** Use `private` fields for dependencies.
